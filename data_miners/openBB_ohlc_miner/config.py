...
data_folder = r'D:\other_data\ohlc_data'
throttle = 5 #seconds in between API query for each symbol, in seconds. Also subtracted from interval.
logfile =r'D:\other_data\ohlc_data\logs\openBB_miner.log'
provider = 'yfinance'
ohlc_interval = '1m'
run_time_of_day = "21:00" #'19:00' #only on the minute. Should be after market close in your time zone. 